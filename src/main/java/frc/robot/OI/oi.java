...
public class oi {
  ...
  static class Buttons {
    ...
    static Trigger LEFT_TRIGGER =
        new Trigger(() -> controller.getLeftTriggerAxis() > DriveConstants.TRIGGER_THRESHOLD);
    static Trigger RIGHT_TRIGGER =
        new Trigger(() -> controller.getRightTriggerAxis() > DriveConstants.TRIGGER_THRESHOLD);
  }
